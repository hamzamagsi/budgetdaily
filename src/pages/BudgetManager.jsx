    ...
    <div className="min-h-screen pb-28 lg:pb-12 bg-[#f3f0ff]">
      ...
      <main className="max-w-6xl mx-auto px-4 sm:px-8 pt-6 space-y-6">
        ...
        <div className="flex items-center justify-between">
          ...
          <div className="flex items-center gap-1.5 px-4 py-2 rounded-2xl bg-white border border-[#e8e4f5] text-xs font-bold text-[#1f2430] shadow-xs">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-6 items-start">
          {/* LEFT COLUMN: TOTAL BUDGET & CONTROLS */}
          <div className="lg:col-span-5 space-y-5">
            ...
            <div className="flex items-center justify-between p-5 rounded-2xl bg-white border border-[#e8e4f5] shadow-xs">
              <div className="flex items-center gap-3">
                ...
                <div>
                  ...
                  <p className="text-[10px] text-[#64748b]">Allocate individual limits</p>
                </div>
              </div>
            ...
            {/* SUMMARY & SAVE BUTTON */}
            <div className="p-5 rounded-2xl bg-[#6c5ce7] text-white space-y-3 shadow-lg shadow-[#6c5ce7]/30">
              <div>
              ...
              <button
                ...
                className="w-full py-3.5 rounded-xl bg-white text-[#6c5ce7] text-xs font-bold hover:bg-white/90 active:scale-95 transition-all cursor-pointer flex items-center justify-center gap-2"
              >
                <Check size={16} />
                <span>{saveToast ? 'Budget Saved!' : 'Save Budget Settings'}</span>
              </button>
            </div>
          </div>
            ...
            {categoryBudgetEnabled ? (
              <div className="figma-card p-6 space-y-4">
                <div className="flex items-center justify-between pb-3 border-b border-[#f1edf9]">
                  <h4 className="text-sm font-bold text-[#1f2430]">Category Allocations</h4>
                  <span className="text-xs text-[#6c5ce7] font-semibold">{categories.length} Categories</span>
                </div>
                ...
                <div className="grid grid-cols-1 sm:grid-cols-2 gap-3">
                  {categories.map((cat) => {
                    ...
                    return (
                      <div
                        key={cat.id}
                        className="flex items-center justify-between p-3.5 rounded-2xl bg-[#f8f6ff] border border-[#e8e4f5]"
                      >
                        <div className="flex items-center gap-3">
                        ...
                        <div className="flex items-center gap-1 px-3 py-1.5 rounded-xl bg-[#e6f4f1] border border-[#c7ede4] text-[#0f766e] text-xs font-mono font-bold">
                          ...
                          <input
                            ...
                            className="w-20 bg-transparent border-none outline-none text-right font-bold text-xs text-[#0f766e]"
                          />
                        </div>
                      </div>
                    )
              ...
              <div className="figma-card p-12 text-center text-xs text-[#64748b]">
                Category-level budgets are currently turned off. Toggle the switch on the left to set custom allocations.
              </div>
            )}
          </div>
        </div>
